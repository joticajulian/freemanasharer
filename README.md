...
The code is located at `packages/contract/src/assembly/Freemanasharer.ts`. With this contract you will be able to define get methods, write methods, and define custom proto buffers.
